...
const Nav = props => {
  return (
    ...
    React.createElement("p", { className: "brand" }, "oguz",

    React.createElement("strong", null, "han")),
...
const About = props => {
  return (
    ...
    React.createElement("h4", { className: "subtitle" }, "My name is Oguz."),
    React.createElement("p", null, "I am a web developer and UX designer based in the beautiful city of Turkey, Ankara."),
...
const Projects = props => {
  return (
    ...
    React.createElement(Project, {
      ...
      tech: "js d3 css",
      link: "#",
      repo: "https://github.com/oguzhanygtr" },
...
const Footer = props => {
  return (
    ...
    React.createElement("div", { className: "wrapper" },
    React.createElement("h3", null, "Made With Love In Ankara"),
    React.createElement("p", null, "\xA9 ", new Date().getFullYear(), " Oguz Yigiter"),
    React.createElement(SocialLinks, null))));
